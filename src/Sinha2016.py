...
class Sinha2016:
    ...
    def __set_str_p_params(self):
        ...
        self.eps_den_e_i = mean_ca_e
        self.eta_ax_e = mean_ca_e * 0.4/0.7
        self.eta_den_e_e = mean_ca_e * 0.2/0.7
        self.eta_den_e_i = mean_ca_e * 0.2/0.7

        # For I
        self.eps_ax_i = mean_ca_i
        self.eps_den_i_e = mean_ca_i
        self.eps_den_i_i = mean_ca_i
        self.eta_ax_i = mean_ca_i * 0.4/0.7
        self.eta_den_i_e = mean_ca_i * 0.2/0.7
        self.eta_den_i_i = mean_ca_i * 0.2/0.7
